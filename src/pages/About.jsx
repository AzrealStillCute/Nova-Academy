...
function About() {
  return (
    <div className=' grid grid-cols-2 justify-items-start mt-36 mb-60'>
        ...
        <div className=''>
            <div className=' flex flex-col justify-between items-start h-full'>
                ...
                <button className=' text-sky-500 text-base flex items-center'>See More <FontAwesomeIcon icon={faArrowRight} className=' ml-2'/></button>
            </div>
        </div>
    </div>
  )
