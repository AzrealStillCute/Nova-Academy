...
function Home() {
  return (
      <div className=' flext flex-col'>
        ...
        <div className=' w-11/12 md:w-3/4 lg:max-w-lg lg:mr-10'>
        ...
        <div className=' h-72 mt-7 md:mt-12 lg:mt-0 lg:h-full w-full lg:w-photo bg-cover bg-center rounded-lg relative' style={{backgroundImage: `url(${heroPhoto})` }}>
            <img src={student} className='hidden lg:block h-20 shadow-2xl rounded-lg absolute left-5 -top-3 lg:top-2 lg:-left-14 rotate-3 hover:scale-105 transition ease-out' />
        ...
        <div className=' grid grid-cols-2 gap-y-10 lg:grid-cols-4 mt-14 lg:mt-32 items-center'>
