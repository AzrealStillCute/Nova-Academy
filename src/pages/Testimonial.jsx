  ...
  return (
    <div className=' mb-72' id='Testimonial'>
        <div className=' text-center mb-10'>
            <span className={styles.subHeading}> Discover Inspiring Testimonials About Nova's Impacts</span>
        ...
        <div className=' flex items-center justify-center mt-10'>
          <button onClick={seeMoreHandle} className={`${styles.bodyText}   hover:ring-1 ring-gray-200 rounded-md p-2 md:p-3`}>
            {
